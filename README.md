...
- `pwd` = Show current directory. Example Output: `/home/kayode`
...
- `cd /home/kayode` = Go to my home directory (absolute path)
...
- `su - admin` = Switch from kayode user to admin
</details>
...
- `HOME=/home/kayode`= current user's home directory
- `USER=kayode` = currently logged in user
<!-- -->
...
- `PATH=$PATH:/home/kayode` = Appending /home/kayode folder to the existing $PATH value
...
## Tech With Nana Bootcamp - [Link](https://techworld-with-nana.teachable.com/)
